...
def plot_batch_metrics(batch_train_losses, batch_val_losses, batch_train_accuracies, batch_val_accuracies, save_path=None):
    """
    ...
    line3 = ax2.plot(batch_train_accuracies, label='Training Accuracy', color='green', alpha=0.7)
    line4 = ax2.plot(batch_val_accuracies, label='Validation Accuracy', color='purple', alpha=0.7)
...
def plot_epoch_metrics(epoch_train_losses, epoch_val_losses, epoch_train_accuracies, epoch_val_accuracies, save_path=None):
    """
    ...
    # Plot losses on primary y-axis
    line1 = ax1.plot(epoch_train_losses, label='Training Loss', color='blue', marker='o', alpha=0.7)
    line2 = ax1.plot(epoch_val_losses, label='Validation Loss', color='red', marker='o', alpha=0.7)
    ax1.set_xlabel('Epoch')
    ax1.set_ylabel('Loss', color='black')
    ax1.tick_params(axis='y', labelcolor='black')
    
    # Plot accuracies on secondary y-axis
    line3 = ax2.plot(epoch_train_accuracies, label='Training Accuracy', color='green', marker='o', alpha=0.7)
    line4 = ax2.plot(epoch_val_accuracies, label='Validation Accuracy', color='purple', marker='o', alpha=0.7)
    ax2.set_ylabel('Accuracy', color='black')
    ax2.tick_params(axis='y', labelcolor='black')
